 ...
 */
class Spark2ProgramRunner extends SparkProgramRunner {

  @Inject
  protected Spark2ProgramRunner(CConfiguration cConf, Configuration hConf, LocationFactory locationFactory,
    ...
    super(cConf, hConf, locationFactory, txClient, datasetFramework, metricsCollectionService,
          ...
          authenticationContext, messagingService, new Spark2RuntimeInfoProvider());
  }
