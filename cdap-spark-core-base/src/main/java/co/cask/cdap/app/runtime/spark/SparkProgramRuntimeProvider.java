...
public abstract class SparkProgramRuntimeProvider implements ProgramRuntimeProvider {
  ...
  protected abstract String getSparkProgramRunnerClassName(Mode mode);
  ...
  public ProgramRunner createProgramRunner(ProgramType type, Mode mode, Injector injector) {
    ...
    String programRunnerClassName = getSparkProgramRunnerClassName(mode);
    switch (mode) {
      case LOCAL:
        ...
        try {
          ...
          try {
            ...
            return createSparkProgramRunner(injector, programRunnerClassName, classLoader);
          } catch (Throwable t) {
      ...
      case DISTRIBUTED:
        ...
        return createSparkProgramRunner(injector, programRunnerClassName,
