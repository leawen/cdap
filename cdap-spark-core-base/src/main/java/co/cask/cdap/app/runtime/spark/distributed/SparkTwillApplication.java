 ...
 */
abstract class SparkTwillApplication extends AbstractProgramTwillApplication {
  ...
  protected void addRunnables(Map<String, RunnableResource> runnables) {
    runnables.put(spec.getName(),
                  new RunnableResource(getSparkTwillRunnable(spec.getName()), createResourceSpec(resources, 1)));
  }

  protected abstract TwillRunnable getSparkTwillRunnable(String name);
}
