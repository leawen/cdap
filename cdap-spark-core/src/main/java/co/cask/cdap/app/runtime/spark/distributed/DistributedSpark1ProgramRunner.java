 ...
 */
public class DistributedSpark1ProgramRunner extends DistributedSparkProgramRunner {

  @Inject
  @VisibleForTesting
  public DistributedSpark1ProgramRunner(TwillRunner twillRunner, YarnConfiguration hConf, CConfiguration cConf,
  ...
  protected TwillApplication getSparkTwillApplication(Program program, Arguments userArguments,
    ...
    return new Spark1TwillApplication(program, userArguments, spec, localizeResources, eventHandler);
  }
}
