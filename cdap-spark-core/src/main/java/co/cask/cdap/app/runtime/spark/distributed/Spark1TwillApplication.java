 ...
 */
public class Spark1TwillApplication extends SparkTwillApplication {

  Spark1TwillApplication(Program program, Arguments runtimeArgs, SparkSpecification spec,
  ...
  protected TwillRunnable getSparkTwillRunnable(String name) {
    return new Spark1TwillRunnable(name);
  }
}
