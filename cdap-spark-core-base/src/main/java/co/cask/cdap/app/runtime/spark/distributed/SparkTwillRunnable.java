 ...
 */
abstract class SparkTwillRunnable extends AbstractProgramTwillRunnable<ProgramRunner> {
  ...
  protected ProgramRunner createProgramRunner(Injector injector) {
    ...
    return getRuntimeProvider().createProgramRunner(ProgramType.SPARK, ProgramRuntimeProvider.Mode.LOCAL, injector);
  }

  protected abstract SparkProgramRuntimeProvider getRuntimeProvider();
}
