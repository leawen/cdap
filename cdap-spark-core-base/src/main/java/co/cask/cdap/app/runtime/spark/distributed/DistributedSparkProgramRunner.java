 ...
 */
public abstract class DistributedSparkProgramRunner extends AbstractDistributedProgramRunner
  ...
  protected ProgramController launch(Program program, ProgramOptions options,
    ...
    TwillController controller = launcher
      ...
      .launch(getSparkTwillApplication(program, options.getUserArguments(), spec, localizeResources));

    return createProgramController(controller, program.getId(), runId);
  }

  protected abstract TwillApplication getSparkTwillApplication(Program program, Arguments userArguments,
