...
/**
  * Required because the way to get InputMetrics changed from Spark1 to Spark2
  */
class Spark1BatchReadableRDD[K: ClassTag, V: ClassTag](@transient sc: SparkContext,
