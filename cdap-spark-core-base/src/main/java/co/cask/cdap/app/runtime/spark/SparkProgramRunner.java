 ...
 */
abstract class SparkProgramRunner extends AbstractProgramRunnerWithPlugin
  ...
  @Inject
  protected SparkProgramRunner(CConfiguration cConf, Configuration hConf, LocationFactory locationFactory,
                               ...
                               SparkRuntimeInfoProvider sparkRuntimeInfoProvider) {
    super(cConf);
    this.cConf = cConf;
    this.hConf = hConf;
  ...
  public ProgramController run(Program program, ProgramOptions options) {
    ...
    try {
      ...
      SparkSubmitter submitter = SparkRuntimeContextConfig.isLocal(hConf)
        ? new LocalSparkSubmitter(sparkRuntimeInfoProvider)
