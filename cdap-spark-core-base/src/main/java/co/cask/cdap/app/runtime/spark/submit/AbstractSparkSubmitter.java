...
import co.cask.cdap.app.runtime.spark.SparkMainWrapperState;
import co.cask.cdap.app.runtime.spark.SparkRuntimeContext;
import co.cask.cdap.app.runtime.spark.SparkRuntimeInfoProvider;
...
public abstract class AbstractSparkSubmitter implements SparkSubmitter {
  ...
  private final SparkRuntimeInfoProvider sparkRuntimeInfoProvider;

  protected AbstractSparkSubmitter(SparkRuntimeInfoProvider sparkRuntimeInfoProvider) {
    this.sparkRuntimeInfoProvider = sparkRuntimeInfoProvider;
  }
  ...
  private void submit(SparkRuntimeContext runtimeContext, String[] args) {
    Cancellable cancellable = SparkRuntimeUtils.setContextClassLoader(
      sparkRuntimeInfoProvider.getClassLoader(runtimeContext));
    try {
  ...
  private List<String> createSubmitArguments(SparkSpecification spec, Map<String, String> configs,
    ...
    builder.add("--class").add(sparkRuntimeInfoProvider.getWrapperClass().getName());
    ...
    return builder
      ...
      .add("--" + SparkMainWrapperState.ARG_USER_CLASS() + "=" + spec.getMainClassName())
      .build();
  }
