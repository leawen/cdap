...
/**
  * A [[co.cask.cdap.api.spark.SparkExecutionContextBase]] that is Serializable. It delegates all operations to
  * the [[co.cask.cdap.api.spark.SparkExecutionContextBase]] in the runtime context.
  */
trait SerializableSparkExecutionContext extends SparkExecutionContextBase with Externalizable {

  def delegate: SparkExecutionContextBase
